    ...
    return (
        <div className='h-screen flex flex-col'>
            ...
            <div className='background-img flex justify-center items-center relative h-screen overflow-hidden'>
                {/* Login Modal */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col justify-between px-5 py-2 w-70 h-100 bg-white border-1 rounded-xl xl:px-10 xl:py-1 xl:justify-around xl:w-180 xl:h-180">
